...
import com.cuupa.classificator.engine.knowledgebase.services.token.CountToken
...
class SenderService(private val senders: List<Sender>) {
    ...
    fun countNumberOfOccurrences(name: String?, text: String?) = CountToken().countOccurences(name, text)
